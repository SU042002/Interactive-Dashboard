...
<div class="container-fluid" style="background-color: #dedcdb">
    ...
    <div class="row"> <!--Create a row for the sidebar and the main content. Making it one row will ensure that the sidebar and the main content are on the same row. -->
        <!--Sidebar-->
        <div class="d-flex col-sm-2 flex-column flex-shrink-0 p-3 text-white" style="height: 100vh; background-color: #151f47; position: sticky; top: 0; overflow-y: auto"> <!--Sidebar-->
                ...
                <ul class="nav nav-pills flex-column mb-auto"> <!--Navigation links-->
                    <li class="nav-item">
                        <a href="index.php" class="nav-link active" aria-current="page"><i class="fa-solid fa-house-medical"></i>
